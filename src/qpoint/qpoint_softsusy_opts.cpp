...
void qpoint_opts::usage() const {
    ...
    << "  " << setw(26) << "-g, --gaugino" << "    ... for gaugino fields, requires MG1, MG2, and MG3 instead of mhf" <<
    endl
    << "  " << setw(26) << "-t, --trilinear" <<
    "    ... for trilinear couplings, requires At, Ab, and Atau instead of A0" << endl
    ...
    << "  " << setw(26) << "    --alpha-em-inv=VAL" << " 1/alpha(EM), at scale MZ, by default:" <<
    default_alpha_em_inv << endl
